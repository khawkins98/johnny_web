...
- **while "cycle catch 2 fish" is on screen** → "cycle catch 3 fish", "cylce catch fish", stop "cycle catch 2 fish"
- **while "cycle catch 1 fish" is on screen** → "cycle catch 2 fish", "cylce catch fish", stop "cycle catch 1 fish"
- **at the start** → "cycle catch 1 fish", "cylce catch fish"
